class Microphone {
    constructor(){
        ...
        .then(function(stream){
            ...
            this.synth = audioContext.createOscillator()
            ...
            this.analyser.fftSize = 128; //fast fourier transform
            ...
            this.synth.connect(this.analyser); //connects microphone audio to analyser
